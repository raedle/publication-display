(function() {
        ...
        // create the qrcode itself
  			...
  			for( var row = 0; row < qrcode.getModuleCount(); row++ ){
  				for( var col = 0; col < qrcode.getModuleCount(); col++ ){
  					context.fillStyle = qrcode.isDark(row, col) ? this.getBackground() : this.getForeground();
   ...
   */
   ...
   Konva.Factory.addGetterSetter(Konva.QrCode, 'background', '#000000');
  ...
  Konva.Factory.addGetterSetter(Konva.QrCode, 'foreground', '#ffffff');
